...
namespace LoveMoneyBlazor.Data
{
    public class ArticleService
    {
        ...
        {
            "../Images/articleImageFiveSmall.jpg",
            "../Images/articleImageFourSmall.jpg",
            "../Images/articleImageThreeSmall.jpg",
        ...
        {
            var rng = new Random();
            return Task.FromResult(Enumerable.Range(1, 3).Select(index => new Article
            {
